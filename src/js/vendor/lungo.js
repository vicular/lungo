...
!function () {
    Lungo.Attributes = {
        count: {selector: "*", html: '<span class="tag count">{{value}}</span>'},
        pull: {
            selector: "*",
        ...
        label: {selector: "*", html: "<abbr>{{value}}</abbr>"},
        icon: {selector: "*", html: '<span class="icon {{value}}"></span>'},
        image: {selector: "*", html: '<img src="{{value}}" class="icon" />'},
        title: {selector: "header", html: '<h1 class="title centered">{{value}}</h1>'},
        loading: {
            selector: "*",
...
!function () {
    Lungo.Constants = {
        ...
        CONTROL: {MENU: "[data-control=menu]"},
        QUERY: {
        ...
        TRIGGER: {LOAD: "load", UNLOAD: "unload"},
        EVENT: {TRANSITION_END: ["webkitAnimationEnd", "animationend"], CHANGE: "change"},
        TRANSITION: {DURATION: 400, ORIGIN: "transition-origin", ATTR: "transition"},
        ASIDE: {NORMAL: 264},
        ATTRIBUTE: {
            ID: "id",
            HREF: "href",
        ...
        BINDING: {START: "{{", END: "}}", KEY: "value", SELECTOR: "{{value}}"},
        DEVICE: {PHONE: "phone", TABLET: "tablet", TV: "tv"},
        ERROR: {
...
!function () {
    Lungo.Resource = function (a, b) {
        ...
        g = function (a) {
            return b.ajax({
                url: a, async: false, dataType: "html", error: function () {
...
!function () {
    Lungo.RouterTablet = function (a) {
        ...
        return {
            section: h, back: f, article: e, history: g, step: i, animationEnd: d, historys: function () {
                return o
            }
        }
    }(Lungo)
